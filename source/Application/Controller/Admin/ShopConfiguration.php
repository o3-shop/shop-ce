...
class ShopConfiguration extends \OxidEsales\Eshop\Application\Controller\Admin\AdminDetailsController
{
    ...
    public function render()
    {
        ...
        if (isset($soxId) && $soxId != "-1") {
            ...
            $aoc = \OxidEsales\Eshop\Core\Registry::getRequest()->getRequestEscapedParameter('aoc');
            if ($aoc == 1) {
    ...
    public function save()
    {
        ...
        if ($shop->load($this->getEditObjectId())) {
            $shop->assign(\OxidEsales\Eshop\Core\Registry::getRequest()->getRequestEscapedParameter('editval'));
            $shop->save();
        }
    }
