...
<table cellspacing="0" cellpadding="0" border="0" width="100%">
    ...
    <tr>
        [{block name="admin_news_list_sorting"}]
        	<td class="listheader first" height="15" width="30" align="center"><a href="Javascript:top.oxid.admin.setSorting( document.search, 'oxnews', 'oxactive', 'asc');document.search.submit();" class="listheader">[{oxmultilang ident="GENERAL_ACTIVTITLE"}]</a></td>
            <td class="listheader" height="15"><a href="Javascript:top.oxid.admin.setSorting( document.search, 'oxnews', 'oxdate', 'asc');document.search.submit();" class="listheader">[{oxmultilang ident="GENERAL_DATE"}]</a></td>
...
[{foreach from=$mylist item=listitem}]
    ...
    <tr id="row.[{$_cnt}]">
        ...
        [{block name="admin_news_list_item"}]
            ...
            [{/if}]
            <td valign="top" class="[{$listclass}][{if $listitem->oxnews__oxactive->value == 1}] active[{/if}]" height="15"><div class="listitemfloating">&nbsp</a></div></td>
