...
$aLang = [
    ...
    'O3_GUARANTEE_ADMIN_HELP_SHOW_NOTICE' => 'Shows the EU-wide harmonised notice on the two-year statutory legal guarantee in the shop. Legally required for most B2C shops (Art. 22a Directive (EU) 2024/825); pure B2B shops are out of scope of this duty.',
    'O3_GUARANTEE_ADMIN_HELP_SHOW_LABEL' => 'Master switch for the product-level durability-guarantee label. The label only displays for articles where a producer guarantee of more than two years is recorded (see the "Extended" tab of the article edit page).',
    'O3_GUARANTEE_ADMIN_HELP_DURATION' => 'Duration of the producer-communicated durability guarantee in months. 0 = no producer guarantee or not communicated. The guarantee label only appears when this value is greater than 24 (more than two years). The trader is not required to research this value themselves.',
    'O3_GUARANTEE_ADMIN_HELP_GUARANTOR' => 'Guarantor/brand name for the guarantee label. Leave empty to automatically use the manufacturer title.',
    'O3_GUARANTEE_ADMIN_HELP_MODEL' => 'Model identifier for the guarantee label (a mandatory label component per Implementing Regulation (EU) 2025/1960). Leave empty to automatically use the article number (OXARTNUM).',
    'O3_GUARANTEE_ADMIN_HELP_CONDITIONS' => 'Guarantee conditions text or link to the guarantee conditions (§ 479 BGB: guarantor name/address, territorial scope, conditions). Becomes relevant once the guarantee label is displayed, since this counts as advertising with the guarantee.',
];
