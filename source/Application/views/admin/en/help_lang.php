...
$aLang = [
    ...
    'HELP_O3_GUARANTEE_FIELDS' => 'Only fill this in if the PRODUCER (not the trader) grants a free durability guarantee of more than 2 years covering the whole product AND this information is available to you (product data sheet, packaging, B2B catalogue). There is no duty to investigate. By displaying the label you advertise the guarantee and must provide the guarantee conditions (sec. 479 German Civil Code) - use the conditions field for that. Non-integer durations (e.g. 30 months) cannot be represented in the EU label and are therefore not label-eligible.',
];
