...
$aLang = [
    ...
    'GENERAL_ADMIN_TITLE' => '[O3-Shop Administration]',
    ...
    'HOME_DESC' => 'Welcome to the O3-Shop Admin. This is an overview of the main areas and functions.',
    ...
    'LOGIN_START' => 'Start O3-Shop Admin',
    'LOGIN_TITLE' => 'O3-Shop Login',
    ...
    'MR' => 'Mr',
    'MRS' => 'Mrs',
    'NAVIGATION_ESHOPADMIN' => 'Shop Admin',
    ...
    'OXDIAG_MAIN_TITLE' => 'Diagnostics of your O3-Shop',
    ...
    'OXDIAG_SHOP_DOES_NOT_FIT' => 'This O3-Shop does not fit 100%',
    'OXDIAG_SHOP_ORIGINAL' => 'This O3-Shop was not modified and is fully original',
    ...
    'SHOP_CACHE_BACKEND_OXID' => 'O3-Shop Disk Storage Cache',
    ...
    'SHOP_CONFIG_DATEFORMAT' => 'Date Format in Shop Admin',
    ...
    'SHOP_CONFIG_SEARCHSUGGEST' => 'Enable Search Suggest Dropdown',
    'SHOP_CONFIG_SEARCHSUGGESTCOUNT' => 'Number of entries in Search Suggest Dropdown',
    'SHOP_CONFIG_SELECTSHOPCOMPONENTS' => 'Select Shop components',
    ...
    'SHOP_CONFIG_TIMEFORMAT' => 'Time Format in Shop Admin',
    ...
    'SHOP_MAIN_NEWSHOP_WARNING' => 'Attention: Creating this sub shop you have to update views, otherwise shops will not work! While generating views, the performance of O3-Shop could be affected.',
    ...
    'SHOP_RDFA_CONTENT_OFFERER' => 'In which content page the RDF data of the <b>Shop</b> shall be embedded?',
    ...
    'SHOP_SYSTEM_VARIANTSSELECTION' => 'Display Variants in Assignment Lists in Shop admin',
    'SHOWLIST_CNT' => 'Cnt',
    ...
    'SYSREQ_DESCRIPTION_FAIL' => 'System health is broken or security is compromised. This O3-Shop will not work properly in all cases and might behave strange.',
    ...
    'SYSREQ_PHP_VERSION' => 'PHP version from 7.4 to 8.2',
    'SYSREQ_PHP_XML' => 'DOM',
    ...
    // EU guarantee labels (Issue #219, Reg. (EU) 2025/1960)
    'mxguaranteeconfig' => 'EU Guarantee Labels',
    'tbclguarantee_config' => 'Settings',
    'O3_GUARANTEE_ADMIN_NAV_LABEL' => 'EU Guarantee Labels',
    'O3_GUARANTEE_ADMIN_CONFIG_SHOW_NOTICE_LABEL' => 'Show legal-guarantee notice (EU-harmonised) in the shop',
    'O3_GUARANTEE_ADMIN_CONFIG_SHOW_NOTICE_HINT' => 'Displays the EU-harmonised notice about the statutory legal guarantee in the footer. Mandatory for B2C shops from 27/09/2026. Pure B2B shops are not affected.',
    'O3_GUARANTEE_ADMIN_CONFIG_SHOW_LABEL_LABEL' => 'Show guarantee label (EU-harmonised) on products',
    'O3_GUARANTEE_ADMIN_CONFIG_SHOW_LABEL_HINT' => 'Displays the EU-harmonised label for producer durability guarantees on qualifying products (product page, checkout, order confirmation). Only free producer guarantees of more than 2 years covering the whole product, whose details are available to the trader, qualify.',
    'O3_GUARANTEE_ADMIN_FIELDS_HEADING' => 'Producer guarantee (EU guarantee label)',
    'O3_GUARANTEE_ADMIN_YEARS_LABEL' => 'Guarantee duration',
    'O3_GUARANTEE_ADMIN_YEARS_UNIT' => 'years (whole numbers)',
    'O3_GUARANTEE_ADMIN_GUARANTOR_LABEL' => 'Guarantor (producer/brand)',
    'O3_GUARANTEE_ADMIN_MODEL_LABEL' => 'Model designation',
    'O3_GUARANTEE_ADMIN_CONDITIONS_LABEL' => 'Guarantee conditions (sec. 479 German Civil Code)',
    'O3_GUARANTEE_ADMIN_WARN_NOT_ELIGIBLE' => 'Note: The EU guarantee label is only shown for a guarantee duration of more than 2 years (Art. 6(1)(la) Consumer Rights Directive). Saving is still possible.',
    'O3_GUARANTEE_ADMIN_WARN_NO_GUARANTOR' => 'Warning: No guarantor can be determined (field empty, no manufacturer linked). The label cannot be shown without a guarantor.',
];
