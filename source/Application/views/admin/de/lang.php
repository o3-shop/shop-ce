...
$aLang = [
    ...
    'CONTENT_MAIN_ISPLAIN' => 'Plaintext',
    ...
    'GENERAL_ADMIN_TITLE' => '[O3-Shop Administrationsbereich]',
    ...
    'HELP_ARTICLE_MAIN_PRICE' => 'Dieser Preis wird an Varianten des Artikels vererbt.<ul><li>Abhängig von den Shopeinstellungen wird der Netto- oder der Bruttopreis eingegeben/angezeigt.</li><li>In Klammern steht immer der Bruttopreis.</li></ul>',
    ...
    'HOME_DESC' => 'Willkommen im O3-Shop Administrationsbereich. Hier finden Sie eine Übersicht über die grundlegenden Bereiche und Funktionen',
    ...
    'LOGIN_START' => 'O3-Shop Admin starten',
    ...
    'OXDIAG_SHOP_DOES_NOT_FIT' => 'Dieser O3-Shop ist nicht 100% original',
    'OXDIAG_SHOP_ORIGINAL' => 'Dieser O3-Shop wurde nicht verändert und ist original',
    ...
    'SHOP_CONFIG_SEARCHSUGGEST' => 'Such-Vorschau Dropdown aktivieren',
    'SHOP_CONFIG_SEARCHSUGGESTCOUNT' => 'Anzahl der Einträge im Such-Vorschau Dropdown',
    'SHOP_CONFIG_SELECTSHOPCOMPONENTS' => 'Shop Funktionen an/ausschalten',
    ...
    'SHOP_MAIN_NEWSHOP_WARNING' => 'Achtung: Nach Anlegen des Subshops bitte Views aktualisieren, da ansonsten die Shops nicht funktionieren. Während dessen die Views erstellt werden, kann es zu Beeinträchtigungen der Performance im O3-Shop kommen.',
    ...
    'SHOP_PERF_CHECKIFTPLCOMPILE' => 'Überprüfen ob Templates neu kompiliert werden müssen. Schalten Sie diese Einstellung aus, wenn der Shop in den Live-Betrieb geht.',
    ...
    'SHOP_RDFA_CONTENT_OFFERER' => 'In welche Content-Seite sollen die RDF-Daten des <b>Shop</b> eingebettet werden?',
    ...
    'SYSREQ_DESCRIPTION_FAIL' => 'Nicht erfüllt. Dieser O3-Shop wird sich in einzelnen Bereichen unerwartet verhalten.',
    ...
    'SYSREQ_PHP_VERSION' => 'PHP Version 7.4 bis 8.2',
    'SYSREQ_PHP_XML' => 'DOM',
