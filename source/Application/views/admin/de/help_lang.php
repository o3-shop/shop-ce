...
$aLang = [
    ...
    'HELP_ARTICLE_EXTEND_BPRICE' => 'Geben Sie den UVP hier an.',
    ...
    'HELP_ARTICLE_EXTEND_FILE' => 'Hier können Sie zusätzliche Dateien zum Artikel angeben.',
    'HELP_ARTICLE_EXTEND_FILEUPLOAD' => 'Hier können Sie zusätzliche Dateien zum Artikel hochladen.',
    ...
    'HELP_ARTICLE_EXTEND_ISSEARCH' => 'Geben Sie an, ob der Artikel mit der Suche gefunden werden soll.',
    'HELP_ARTICLE_EXTEND_MASS' => 'Geben Sie die Maße des Artikels in Metern an.',
    ...
    'HELP_ARTICLE_EXTEND_URLDESC' => 'Hier geben Sie den Text an, der statt der URL angezeigt wird.',
    'HELP_ARTICLE_EXTEND_WEIGHT' => 'Geben Sie das Gewicht des Artikels in kg an.',
    ...
    'HELP_ARTICLE_MAIN_ACTIVE' => 'Gibt an, ob der Artikel aktiv ist oder nicht. Nicht aktive Artikel werden nie angezeigt.',
    'HELP_ARTICLE_MAIN_ACTIVFROMTILL' => 'Geben Sie an von wann bis wann der Artikel aktiv sein soll. Wenn Sie keinen Zeitraum eingeben, ist der Artikel immer aktiv.',
    ...
    'HELP_ARTICLE_MAIN_ARTNUM' => 'Die Artikelnummer des Artikels.',
    'HELP_ARTICLE_MAIN_DISTEAN' => 'Die Hersteller-EAN des Artikels.',
    'HELP_ARTICLE_MAIN_EAN' => 'Ihre eigene EAN des Artikels.',
    'HELP_ARTICLE_MAIN_HIDDEN' => 'Versteckte Artikel werden in den Listen nicht angezeigt. Sie sind allerdings in der Suche und per direkter URL erreichbar.',
    'HELP_ARTICLE_MAIN_MANUFACTURERID' => 'Der Artikelhersteller.',
    'HELP_ARTICLE_MAIN_MPN' => 'Die Artikelnummer des Herstellers.',
    'HELP_ARTICLE_MAIN_SEARCHKEYS' => 'Suchbegriffe, unter denen der Artikel auch gefunden wird.',
    'HELP_ARTICLE_MAIN_SHORTDESC' => 'Kurzbeschreibung des Artikels.',
    'HELP_ARTICLE_MAIN_TITLE' => 'Geben Sie einen aussagekräftigen Artikelnamen ein, der in Suchmaschinen gut gefunden und gerankt wird.',
    ...
    'HELP_ARTICLE_MAIN_VENDORID' => 'Ihr Lieferant für diesen Artikel.',
    ...
    'HELP_ARTICLE_REVIEW_ACTIVE' => 'Gibt an, ob diese Bewertung im Shop sichtbar ist.',
    'HELP_ARTICLE_REVIEW_TEXT' => 'Der Bewertungstext des Kunden.',
    ...
    'HELP_ARTICLE_STOCK_DELTIME' => 'Die Lieferzeit des Artikels. Geben Sie beide Werte an.',
    ...
    'HELP_ARTICLE_STOCK_STOCK' => 'Der aktuelle Lagerbestand des Artikels. Wird beim Kauf des Artikels automatisch aktualisiert.',
    ...
    'HELP_ARTICLE_VARIANT_SELECTLIST' => 'Die Auswahllisten, die dieser Artikelvariante zugeordnet sind.',
    ...
    'HELP_ATTRIBUTE_MAIN_SORTING' => 'Die Sortierung. Hiermit können verschiedene Attribute in der gewünschten Reihenfolge angezeigt werden.',
    'HELP_CATEGORY_MAIN_ACTIVE' => 'Ist die Kategorie aktiv? Nur aktivierte Kategorien werden in der Kategorie-Navigation angezeigt.',
    ...
    'HELP_CATEGORY_MAIN_DESCRIPTION' => 'Die Kategorie-Kurzbeschreibung.',
    ...
    'HELP_CATEGORY_MAIN_ICON' => 'Symbol für die Kategorie.',
    ...
    'HELP_CATEGORY_MAIN_TEMPLATE' => 'Ein separates Template für die Kategorie, falls gewünscht.',
    ...
    'HELP_CATEGORY_MAIN_TITLE' => 'Der Name der Kategorie. Wird in der Kategorie-Navigation angezeigt.',
    'HELP_CATEGORY_MAIN_VAT' => 'Gibt es eine spezielle Mehrwertsteuer für die Artikel in dieser Kategorie?',
    ...
    'HELP_CONTENT_MAIN_INSERTBEFORE' => 'Wählen Sie den Inhalt aus, vor dem dieser Inhalt im Shop eingefügt werden soll.',
    ...
    'HELP_COUNTRY_MAIN_ISO2' => 'ISO2, zum Beispiel "DE".',
    'HELP_COUNTRY_MAIN_ISO3' => 'ISO3, zum Beispiel "DEU".',
    'HELP_COUNTRY_MAIN_ISOUNNUM' => 'ISO-UN-Nummer des Landes.',
    'HELP_COUNTRY_MAIN_OXVATSTATUS_0' => 'Für dieses Land wird grundsätzlich keine Mehrwertsteuer berechnet.',
    'HELP_COUNTRY_MAIN_OXVATSTATUS_1' => 'Keine Mehrwertsteuer wird nur berechnet, wenn eine gültige Umsatzsteuer-ID angegeben wurde.',
    ...
    'HELP_DISCOUNT_MAIN_EXTRA' => 'Geben Sie hier ein kostenloses Zugabe-Produkt an, das bei Erfüllung der Rabattbedingungen automatisch zum Warenkorb hinzugefügt wird.',
    ...
    'HELP_DYNBASE_ADDCATTOCAMPAIGN' => 'Aktivieren Sie diese Option, um die Hauptkategorie der Artikel als Kampagnenparameter in die Tracking-URLs aufzunehmen.',
    'HELP_GENERAL_ACTIVE' => 'Gibt an, ob der Shop aktiv ist oder nicht. Nicht aktivierte Shops werden nicht angezeigt.',
    'HELP_GENERAL_ACTIVFROMTILL' => 'Geben Sie an von wann bis wann dies aktiv sein soll. Wenn Sie keinen Zeitraum eingeben, ist dies immer aktiv.',
    'HELP_GENERAL_BEGINDATE' => 'Das Startdatum. Tag, Monat und Jahr und Zeit.',
    'HELP_GENERAL_BILLSAL' => 'Die Anrede.',
    'HELP_GENERAL_BIRTHDATE' => 'Das Geburtsdatum. Tag, Monat und Jahr.',
    'HELP_GENERAL_CATEGORYSELECT' => 'Die Kategorie, der dieser Eintrag zugeordnet ist.',
    'HELP_GENERAL_COMPANY' => 'Die Firma.',
    'HELP_GENERAL_COUNTRY' => 'Das Land.',
    'HELP_GENERAL_DATE' => 'Das Datum dieses Eintrags.',
    'HELP_GENERAL_DELIVERYCOST' => 'Die anfallenden Versandkosten.',
    'HELP_GENERAL_DESCRIPTION' => 'Die Beschreibung.',
    'HELP_GENERAL_EMAIL' => 'Die E-Mail-Adresse.',
    'HELP_GENERAL_ENDDATE' => 'Das Startdatum. Tag, Monat und Jahr und Zeit.',
    'HELP_GENERAL_EXPORTCAMPAIGN' => 'Der Kampagnenparameter, der an die exportierten URLs angehängt wird.',
    'HELP_GENERAL_EXPORTCUSTOMHEADER' => 'Eine benutzerdefinierte Kopfzeile für die Exportdatei.',
    'HELP_GENERAL_EXPORTDELCOST' => 'Die Versandkosten, die beim Export verwendet werden sollen.',
    'HELP_GENERAL_EXPORTLANGUAGE' => 'Die Sprache, für die der Export ausgegeben wird.',
    'HELP_GENERAL_EXPORTMAINVARS' => 'Gibt an, ob der Vaterartikel von Varianten mit exportiert wird.',
    'HELP_GENERAL_EXPORTMINPRICE' => 'Nur Artikel ab diesem Mindest-Bruttopreis werden exportiert.',
    'HELP_GENERAL_EXPORTMINSTOCK' => 'Nur Artikel mit mindestens diesem Lagerbestand werden exportiert.',
    'HELP_GENERAL_EXPOSTVARS' => 'Gibt an, ob Varianten in den Export eingeschlossen werden.',
    'HELP_GENERAL_EXTRAINFO' => 'Nützliche zusätzliche Informationen.',
    'HELP_GENERAL_FAX' => 'Die Faxnummer.',
    'HELP_GENERAL_FIELDS' => 'Felder, die zusätzlich von den Kunden abgefragt werden. Zum Beispiel: IBAN, Bank, BIC Lastschrift.',
    'HELP_GENERAL_FON' => 'Die Telefonnummer.',
    'HELP_GENERAL_ICON' => 'Ein Icon/Logo für den Hersteller.',
    'HELP_GENERAL_IDENT' => 'Der eindeutige Bezeichner dieses Eintrags.',
    'HELP_GENERAL_INFOLDER' => 'Der Ordner, dem dieser Eintrag zugeordnet ist.',
    'HELP_GENERAL_LANGUAGE' => 'Sprache für die Anzeige der Info.',
    'HELP_GENERAL_LINK' => 'Der Link, der diesem Eintrag zugeordnet ist.',
    'HELP_GENERAL_NAME' => 'Vorname und Nachname.',
    'HELP_GENERAL_ORDERNUM' => 'Die Sortierungsnummer dieses Eintrags.',
    'HELP_GENERAL_PRICE' => 'Der Preis dieses Artikels.',
    'HELP_GENERAL_SEARCHKEY' => 'Optionale Suchbegriffe, über die dieser Eintrag gefunden werden kann.',
    ...
    'HELP_GENERAL_SEO_URL' => 'Eine URL, die in Suchmaschinen gut gefunden und gerankt wird.',
    'HELP_GENERAL_SHORTDESC' => 'Die Kurzbeschreibung',
    'HELP_GENERAL_SORT' => 'Die Sortierung. Höhere Nummern werden nach unten sortiert.',
    'HELP_GENERAL_STATE' => 'Das Bundesland oder der Staat der Adresse.',
    'HELP_GENERAL_STREET' => 'Die Strasse mit Hausnummer.',
    'HELP_GENERAL_STREETNUM' => 'Die Hausnummer.',
    'HELP_GENERAL_SUM' => 'Die Summe.',
    'HELP_GENERAL_TELEPHONE' => 'Die Telefonnummer.',
    'HELP_GENERAL_TITLE' => 'Die Bezeichnung.',
    'HELP_GENERAL_TYPE' => 'Der Typ dieses Eintrags.',
    'HELP_GENERAL_URL' => 'Die URL.',
    'HELP_GENERAL_USTID' => 'Europäische Umsatzsteuer-Identifikationsnummer.',
    'HELP_GENERAL_ZIPCITY' => 'Die Postleitzahl.',
    'HELP_GENIMPORT_CSVFILE' => 'Wählen Sie die CSV-Datei aus, die importiert werden soll.',
    'HELP_GENIMPORT_DBFIELDS' => 'Ordnen Sie die Spalten der CSV-Datei den entsprechenden Datenbankfeldern der Zieltabelle zu.',
    ...
    'HELP_GENIMPORT_TABLE' => 'Wählen Sie die Datenbanktabelle aus, in die die importierten Daten geschrieben werden sollen.',
    'HELP_LANGUAGE_ABBERVATION' => 'Geben Sie das Sprachkürzel (z. B. „de" oder „en") für diese Sprache ein.',
    ...
    'HELP_LANGUAGE_BASESSLURL' => 'Geben Sie die Basis-SSL-URL (https://…) ein, die für diese Sprache im Shop verwendet wird.',
    'HELP_LANGUAGE_BASEURL' => 'Geben Sie die Basis-URL (http://…) ein, die für diese Sprache im Shop verwendet wird.',
    ...
    'HELP_LANGUAGE_DESCRIPTION' => 'Geben Sie den vollständigen Namen der Sprache ein (z. B. „Deutsch" oder „English").',
    ...
    'HELP_MANUFACTURER_MAIN_ICONUPLOAD' => 'Ein Icon/Logo für den Hersteller hochladen',
    ...
    'HELP_NEWSLETTER_PLAIN_TEXT' => 'Geben Sie hier die Plain-Text-Version des Newsletters für E-Mail-Clients ein, die kein HTML unterstützen.',
    'HELP_NEWS_MAIN_SHORTDESC' => 'Geben Sie einen kurzen Titeltext für diese News-Meldung ein, der in der Übersicht angezeigt wird.',
    'HELP_ORDER_MAIN_BILLNUM' => 'Die Rechnungsnummer dieser Bestellung.',
    'HELP_ORDER_MAIN_DELTYPE' => 'Der Versanddienstleister, mit dem diese Bestellung versendet wurde.',
    'HELP_ORDER_MAIN_DISCOUNT' => 'Der auf diese Bestellung angewendete Rabatt.',
    'HELP_ORDER_MAIN_PAIDON' => 'Das Datum, an dem die Zahlung für diese Bestellung eingegangen ist.',
    'HELP_ORDER_MAIN_PAIDWITH' => 'Die Zahlungsart, mit der diese Bestellung bezahlt wurde.',
    'HELP_ORDER_MAIN_TRACKCODE' => 'Der Tracking-Code zur Sendungsverfolgung dieser Bestellung.',
    'HELP_ORDER_OVERVIEW_INFOLDER' => 'Der Ordner, dem diese Bestellung zugeordnet ist.',
    ...
    'HELP_PAYMENT_MAIN_NAME' => 'Der Name der Zahlungsart.',
    ...
    'HELP_RIGHTSROLES_ACTIVE' => 'Gibt an, ob die Rolle aktiv ist.',
    'HELP_SELECTLIST_MAIN_ADDFIELD_NAME' => 'Geben Sie den Namen des neuen Auswahllistenfeldes ein.',
    'HELP_SELECTLIST_MAIN_ADDFIELD_POS' => 'Geben Sie die Sortierreihenfolge (Position) dieses Feldes innerhalb der Auswahlliste an.',
    'HELP_SELECTLIST_MAIN_ADDFIELD_PREIS' => 'Geben Sie den Preisauf- oder -abschlag ein, der bei Auswahl dieses Feldes auf den Artikelpreis angewendet wird.',
    ...
    'HELP_SHOP_CONFIG_ACTIVECATEGORYBYSTART' => 'Legt fest, welche Kategorie beim Start des Shops in der Navigation aufgeklappt angezeigt wird.',
    ...
    'HELP_SHOP_CONFIG_ALLOWUNEVENAMOUNTS' => 'Erlaubt Kunden, nicht ganzzahlige Mengen (z. B. 1,5) bei der Bestellung einzugeben.',
    ...
    'HELP_SHOP_CONFIG_AUTOICONS' => 'Generiert Artikel-Icons automatisch aus den Thumbnails, wenn kein eigenes Icon hinterlegt ist.',
    ...
    'HELP_SHOP_CONFIG_CALCDELVATONTOP' => 'Versandkosten werden als Nettopreise eingegeben und die Mehrwertsteuer wird beim Berechnen aufgeschlagen.',
    'HELP_SHOP_CONFIG_CALCPAYVATONTOP' => 'Zahlungsarten-Gebühren werden als Nettopreise eingegeben und die Mehrwertsteuer wird aufgeschlagen.',
    'HELP_SHOP_CONFIG_CALCULATEVATFORDELIVERY' => 'Im Warenkorb und auf der Rechnung werden Versandkosten als Nettobetrag zuzüglich Mehrwertsteuer statt als Bruttobetrag ausgewiesen.',
    'HELP_SHOP_CONFIG_CALCULATEVATFORWRAPPING' => 'Die in Geschenkverpackungen und Grußkarten enthaltene Mehrwertsteuer wird im Warenkorb und auf der Rechnung separat ausgewiesen.',
    'HELP_SHOP_CONFIG_CALCULATEVATOFORPAYCHARGE' => 'Die in Zahlungsarten-Gebühren enthaltene Mehrwertsteuer wird im Warenkorb und auf der Rechnung separat ausgewiesen.',
    'HELP_SHOP_CONFIG_CALCWRAPVATONTOP' => 'Preise für Geschenkverpackungen und Grußkarten werden als Nettopreise eingegeben und die Mehrwertsteuer wird aufgeschlagen.',
    'HELP_SHOP_CONFIG_CMSFOLDER' => 'Legt die verfügbaren Ordner fest, in die CMS-Seiten im Administrationsbereich einsortiert werden können.',
    'HELP_SHOP_CONFIG_CNTOFNEWS' => 'Gibt an, wie viele Neuigkeiten in der Nachrichten-Box im Shop angezeigt werden.',
    'HELP_SHOP_CONFIG_CONFIRMAGB' => 'Kunden müssen die Allgemeinen Geschäftsbedingungen während des Bestellvorgangs aktiv bestätigen.',
    'HELP_SHOP_CONFIG_CONFIRMCOOKIE' => 'Kunden müssen der Verwendung von Cookies aktiv zustimmen, bevor diese gesetzt werden.',
    'HELP_SHOP_CONFIG_CSVSEPARATOR' => 'Legt das Trennzeichen fest, das beim CSV-Im- und Export verwendet wird.',
    'HELP_SHOP_CONFIG_DATEFORMAT' => 'Legt das Datumsformat fest, das im Administrationsbereich des Shops angezeigt wird.',
    ...
    'HELP_SHOP_CONFIG_DEFAULTVAT' => 'Legt den Standard-Mehrwertsteuersatz fest, der für alle Artikel gilt, denen kein eigener Steuersatz zugewiesen ist.',
    ...
    'HELP_SHOP_CONFIG_DELIVERYCOSTS' => 'Versandkosten werden berechnet und angezeigt, auch wenn der Kunde noch nicht eingeloggt ist.',
    'HELP_SHOP_CONFIG_DISABLEARTDUBLICATES' => 'Kopierte Artikel werden nicht automatisch auf den Status "Aktiv" gesetzt.',
    ...
    'HELP_SHOP_CONFIG_EXCLUDENONMATERIALPRODUCTS' => 'Nicht materielle Artikel (z. B. Gutscheine) werden bei der Berechnung der Versandkosten nicht berücksichtigt.',
    'HELP_SHOP_CONFIG_EXPORTNUMBEROFLINES' => 'Gibt an, wie viele Zeilen pro Tick beim CSV-Export verarbeitet werden.',
    ...
    'HELP_SHOP_CONFIG_INLANDCUSTOMERS' => 'Kunden aus den hier ausgewählten Ländern werden automatisch der Benutzergruppe "Inlandskunden" zugeordnet.',
    ...
    'HELP_SHOP_CONFIG_LARGECUSTOMERPRICE' => 'Gibt den Mindesteinkaufswert an, ab dem Kunden der Benutzergruppe "Großer Umsatz" zugeordnet werden.',
    ...
    'HELP_SHOP_CONFIG_MIDLLECUSTOMERPRICE' => 'Gibt den Mindesteinkaufswert an, ab dem Kunden der Benutzergruppe "Mittlerer Umsatz" zugeordnet werden.',
    'HELP_SHOP_CONFIG_MINORDERPRICE' => 'Legt den Mindestbestellwert fest; Bestellungen unterhalb dieses Betrags werden nicht akzeptiert (leer lassen, um die Prüfung zu deaktivieren).',
    ...
    'HELP_SHOP_CONFIG_NROFCUSTOMERWHOARTICLES' => 'Gibt an, wie viele Artikel im Bereich "Kunden, die dies gekauft haben, kauften auch" angezeigt werden.',
    'HELP_SHOP_CONFIG_NROFNEWCOMERARTICLES' => 'Gibt an, wie viele Artikel im Bereich "Frisch eingetroffen!" (neuste Artikel) angezeigt werden.',
    'HELP_SHOP_CONFIG_NUMBEROFCROSSSELLARTICLES' => 'Gibt an, wie viele Crossselling-Artikel und Zubehör-Artikel auf der Produktdetailseite angezeigt werden.',
    'HELP_SHOP_CONFIG_NUMBEROFEMAILSPERTICK' => 'Gibt an, wie viele Newsletter-E-Mails pro Tick vom System versendet werden.',
    'HELP_SHOP_CONFIG_NUMBEROFSIMILARARTICLES' => 'Gibt an, wie viele ähnliche Artikel auf der Produktdetailseite angezeigt werden.',
    'HELP_SHOP_CONFIG_ORDERFOLDER' => 'Legt die verfügbaren Ordner fest, in die Bestellungen in der Bestellungsverwaltung einsortiert werden können.',
    ...
    'HELP_SHOP_CONFIG_RSSARTRECOMMLISTS' => 'Aktiviert den RSS-Feed für die Lieblingslisten-Übersicht.',
    'HELP_SHOP_CONFIG_RSSBARGAIN' => 'Aktiviert den RSS-Feed für Schnäppchen-Artikel.',
    'HELP_SHOP_CONFIG_RSSCATEGORIES' => 'Aktiviert den RSS-Feed für Kategorien.',
    'HELP_SHOP_CONFIG_RSSITEMSCOUNT' => 'Gibt an, wie viele Einträge in den RSS-Feeds des Shops angezeigt werden.',
    'HELP_SHOP_CONFIG_RSSNEWEST' => 'Aktiviert den RSS-Feed für die neuesten Artikel.',
    'HELP_SHOP_CONFIG_RSSRECOMMLISTARTS' => 'Aktiviert den RSS-Feed für Artikel in Lieblingslisten.',
    'HELP_SHOP_CONFIG_RSSSEARCH' => 'Aktiviert den RSS-Feed für Suchergebnisse.',
    'HELP_SHOP_CONFIG_RSSSELECTED' => 'Legt fest, welche RSS-Feeds im Shop angezeigt und verlinkt werden.',
    'HELP_SHOP_CONFIG_RSSTOPSHOP' => 'Aktiviert den RSS-Feed für die Top-Artikel des Shops.',
    ...
    'HELP_SHOP_CONFIG_SHIPPINGCOUNTRYVAT' => 'Für die Mehrwertsteuerberechnung wird das Lieferland statt des Rechnungslandes des Kunden verwendet.',
    'HELP_SHOP_CONFIG_SHOWORDERBUTTONONTHETOP' => 'Im vierten Bestellschritt wird zusätzlich oben auf der Seite ein "Zahlungspflichtig bestellen"-Button angezeigt.',
    ...
    'HELP_SHOP_CONFIG_SORTITEMSLIST' => 'Kunden können Artikellisten im Shop nach verschiedenen Kriterien sortieren.',
    ...
    'HELP_SHOP_CONFIG_STOCKWARNINGLIMIT' => 'Legt den Lagerbestand fest, ab dem Kunden darauf hingewiesen werden, dass nur noch wenige Artikel verfügbar sind.',
    'HELP_SHOP_CONFIG_TIMEFORMAT' => 'Legt das Zeitformat fest, das im Administrationsbereich des Shops angezeigt wird.',
    ...
    'HELP_SHOP_CONFIG_USESTOCK' => 'Aktiviert die Lagerverwaltung, sodass Lagerbestände verfolgt und Bestellungen entsprechend eingeschränkt werden.',
    'HELP_SHOP_CONFIG_VIEWNETPRICE' => 'Im Shop werden Artikelpreise als Nettopreise angezeigt.',
    'HELP_SHOP_CONFIG_WARNONSAMEARTNUMS' => 'Zeigt eine Warnung an, wenn eine Artikelnummer bereits von einem anderen Artikel verwendet wird.',
    ...
    'HELP_SHOP_MAIN_BANKCODE' => 'Bankleitzahl',
    'HELP_SHOP_MAIN_BANKNAME' => 'Der Bankname',
    'HELP_SHOP_MAIN_BANKNUMBER' => 'Kontonummer der Inhaberfirma',
    'HELP_SHOP_MAIN_BICCODE' => 'BIC/SWIFT Nummer der Bank.',
    'HELP_SHOP_MAIN_COMPANY' => 'Die Inhaberfirma dieses Shops.',
    'HELP_SHOP_MAIN_COURT' => 'Amtsgericht, bei dem die Firma registriert ist',
    'HELP_SHOP_MAIN_FORGOTPWDSUBJECT' => 'E-Mail-Betreff für die "Passwort vergessen"-Mail.',
    'HELP_SHOP_MAIN_HRBNR' => 'Handelsregisternummer',
    ...
    'HELP_SHOP_MAIN_NOWSENDEDSUBJECT' => 'E-Mail-Betreff für Versandbestätigungen.',
    ...
    'HELP_SHOP_MAIN_ORDERSUBJECT' => 'E-Mail-Betreff für die Bestellmail an Bestellende.',
    ...
    'HELP_SHOP_MAIN_REGISTERSUBJECT' => 'E-Mail-Betreff für Neue Registrierungen.',
    'HELP_SHOP_MAIN_SHOPNAME' => 'Der Name dieses Shops',
    'HELP_SHOP_MAIN_SMTPPASSWORD' => 'Das Passwort für die Anmeldung am Mailserver.',
    ...
    'HELP_SHOP_MAIN_SMTPUSER' => 'Mail-User mit dem die Anmeldung am Mailserver stattfindet. Wichtig für den Spam-Schutz.',
    'HELP_SHOP_MAIN_TAXNUMBER' => 'Steuernummer',
    'HELP_SHOP_MAIN_VATNUMBER' => 'Europäische Umsatzsteuer-Identifikationsnummer.',
    ...
    'HELP_SHOP_PERF_CALCVATONLYFORBASKETORDER' => 'Legt fest, ob länderspezifische Mehrwertsteuersätze nur im Warenkorb und im Bestellprozess berechnet werden (verbessert die Performance außerhalb des Checkouts).',
    ...
    'HELP_SHOP_PERF_DONTSHOWEMTYCATEGORIES' => 'Legt fest, ob leere Kategorien (ohne Unterkategorien und ohne Artikel) im Shop-Frontend ausgeblendet werden.',
    'HELP_SHOP_PERF_LOADACCESSOIRES' => 'Legt fest, ob Zubehör-Artikel auf der Artikeldetailseite im Shop-Frontend geladen werden (beeinflusst die Performance).',
    ...
    'HELP_SHOP_PERF_LOADCROSSSELLING' => 'Legt fest, ob Cross-Selling-Artikel auf der Artikeldetailseite im Shop-Frontend geladen werden (beeinflusst die Performance).',
    'HELP_SHOP_PERF_LOADCURRENCY' => 'Legt fest, ob die Währungsauswahl im Shop-Frontend angezeigt wird (beeinflusst die Performance).',
    'HELP_SHOP_PERF_LOADCUSTOMERWHOBOUGHTTHIS' => 'Legt fest, ob die Rubrik „Kunden, die diesen Artikel gekauft haben, kauften auch …" im Shop-Frontend geladen wird (beeinflusst die Performance).',
    ...
    'HELP_SHOP_PERF_LOADLANGUAGES' => 'Legt fest, ob die Sprachauswahl im Shop-Frontend angezeigt wird (beeinflusst die Performance).',
    'HELP_SHOP_PERF_LOADMANUFACTURERTREE' => 'Legt fest, ob die Herstellerliste im Shop-Frontend geladen und angezeigt wird (beeinflusst die Performance).',
    'HELP_SHOP_PERF_LOADNEWS' => 'Legt fest, ob Neuigkeiten im Shop-Frontend geladen werden (beeinflusst die Performance).',
    'HELP_SHOP_PERF_LOADNEWSONLYSTART' => 'Legt fest, ob Neuigkeiten ausschließlich auf der Startseite geladen werden (reduziert die Performance-Belastung auf allen anderen Seiten).',
    ...
    'HELP_SHOP_PERF_LOADPRICEFORADDLIST' => 'Legt fest, ob Preise in den Rubriken „Top of the Shop" und „Frisch eingetroffen!" angezeigt werden (beeinflusst die Performance).',
    'HELP_SHOP_PERF_LOADSELECTLIST' => 'Legt fest, ob Auswahllisten auf der Artikeldetailseite im Shop-Frontend geladen werden (beeinflusst die Performance).',
    ...
    'HELP_SHOP_PERF_LOADSIMILAR' => 'Legt fest, ob ähnliche Artikel auf der Artikeldetailseite im Shop-Frontend geladen werden (beeinflusst die Performance).',
    'HELP_SHOP_PERF_LOADVARIANTS' => 'Legt fest, ob Varianten in Artikellisten (z. B. Suchergebnisse, Kategorieansichten) geladen werden (hoher Speicherbedarf, kann die Performance auf schwachen Servern beeinträchtigen).',
    ...
    'HELP_SHOP_PERF_SHOWACTCATARTCOUNT' => 'Legt fest, ob die Anzahl der enthaltenen Artikel hinter den Kategorienamen in der Navigation angezeigt wird (beeinflusst die Performance).',
    ...
    'HELP_SHOP_PERF_USETIMECHECKINARTLOAD' => 'Legt fest, ob beim Laden von Artikeln die Felder „Aktiv von" und „Aktiv bis" geprüft werden (beeinflusst die Performance).',
    ...
    'HELP_SHOP_RDFA_EMBEDDING' => 'Legt fest, ob strukturierte RDFa-Daten automatisch in die Shop-Seiten eingebettet werden, um maschinell lesbare Produktinformationen bereitzustellen.',
    ...
    'HELP_SHOP_SEO_STARTTITLE' => 'Legt den Seitentitel der Startseite fest, der im Browser-Tab und in Suchmaschinenergebnissen angezeigt wird.',
    ...
    'HELP_SHOP_SEO_STDURL' => 'Legt die Standard-URL des Shops fest, die als Basis für die Generierung aller weiteren URLs verwendet wird.',
    ...
    'HELP_SHOP_SYSTEM_ATTRIBUTESPERCENT' => 'Legt den Prozentsatz übereinstimmender Attribute fest, ab dem zwei Artikel als ähnlich eingestuft werden.',
    ...
    'HELP_SHOP_SYSTEM_GBMODERATE' => 'Legt fest, ob Artikelbewertungen vor der Veröffentlichung von einem Administrator freigegeben werden müssen.',
    ...
    'HELP_SHOP_SYSTEM_INTERFACEPROFILES' => 'Legt die Profile für den Administrationsbereich fest (Auflösung und Anzahl der Zeilen im Listenbereich).',
    ...
    'HELP_SHOP_SYSTEM_LOGSKIPTAGS' => 'Legt fest, welche Änderungen im Administrationsbereich vom Admin-Protokoll ausgeschlossen werden.',
    'HELP_SHOP_SYSTEM_ORDERDISNOREG' => 'Legt fest, ob Kunden sich registrieren müssen, bevor sie eine Bestellung aufgeben können.',
    ...
    'HELP_SHOP_SYSTEM_SHOWREMEMBERME' => 'Legt fest, ob die Option „Angemeldet bleiben" im Login-Bereich des Shops angezeigt wird.',
    ...
    'HELP_SHOP_SYSTEM_STOREIPS' => 'Legt fest, ob IP-Adressen der Benutzer gespeichert werden (bitte prüfen Sie die Zulässigkeit gemäß den geltenden Datenschutzbestimmungen).',
    'HELP_SHOP_SYSTEM_USEMULTIDIMENSIONVARIANTS' => 'Legt fest, ob mehrdimensionale Varianten (z. B. Größe und Farbe gleichzeitig) im Shop aktiviert werden.',
    ...
    'HELP_TOOLS_MAIN_SQLDUMB' => 'Importieren Sie eine SQL-Datei, um Datenbankbefehle direkt auszuführen (große Dateien bitte per FTP hochladen).',
    'HELP_TOOLS_MAIN_UPDATESQL' => 'Führen Sie ein SQL-Update-Skript aus, um die Datenbankstruktur oder -inhalte zu aktualisieren.',
    'HELP_USER_ADDRESS_DELIVERYADDRESS' => 'Bekannte Lieferadresssen.',
    ...
    'HELP_USER_EXTEND_MOBILFON' => 'Die Mobiltelefonnummer',
    'HELP_USER_EXTEND_NEWSLETTER' => 'Diese Einstellung zeigt an, ob der Benutzer den Newsletter abonniert hat oder nicht.',
    'HELP_USER_EXTEND_PRIVATFON' => 'Die private Telefonnummer',
    'HELP_USER_MAIN_CUSTOMERSNR' => 'Die Kundennummer dieses Benutzers.',
    'HELP_USER_MAIN_EMAILLOGIN' => 'Die E-Mail-Adresse, mit der sich der Benutzer anmeldet.',
    ...
    'HELP_USER_MAIN_NAME' => 'Der Vor- und Nachname des Benutzers.',
    'HELP_USER_MAIN_NEWPASSWORD' => 'Ein neues Passwort für diesen Benutzer (leer lassen, um das bestehende zu behalten).',
    'HELP_USER_MAIN_RIGHTS' => 'Die Zugriffsrechte dieses Benutzers im Adminbereich.',
    'HELP_USER_MAIN_STRNR' => 'Die Straße und Hausnummer des Benutzers.',
    ...
    'HELP_USER_PAYMENT_PAYMENTTYPE' => 'Die Zahlmethoden.',
    'HELP_VENDOR_MAIN_ICONUPLOAD' => 'Laden Sie ein Icon-Bild für diesen Hersteller hoch, das im Shop angezeigt wird.',
    ...
    'HELP_VOUCHERSERIE_MAIN_MINORDERPRICE' => 'Mindestbestellwert, ab dem ein Gutschein aus der Serie gültig ist',
    ...
    'HELP_WRAPPING_MAIN_PICUPLOAD' => 'Laden Sie ein Vorschaubild für diese Verpackungsoption hoch, das dem Kunden im Bestellprozess angezeigt wird.',
    'O3_GUARANTEE_ADMIN_HELP_SHOW_NOTICE' => 'Zeigt den EU-weit einheitlichen Hinweis auf die zweijährige gesetzliche Gewährleistung im Shop an. Für die meisten B2C-Shops gesetzlich vorgeschrieben (Art. 22a Richtlinie (EU) 2024/825); reine B2B-Shops sind von dieser Pflicht nicht betroffen.',
    'O3_GUARANTEE_ADMIN_HELP_SHOW_LABEL' => 'Haupt-Schalter für das Garantie-Label auf Artikelebene. Das Label wird nur für Artikel angezeigt, bei denen eine Herstellergarantie von mehr als zwei Jahren hinterlegt ist (siehe Registerkarte "Erweitert" der Artikelbearbeitung).',
    'O3_GUARANTEE_ADMIN_HELP_DURATION' => 'Dauer der vom Hersteller angegebenen Haltbarkeitsgarantie in Monaten. 0 = keine Herstellergarantie bzw. keine Angabe. Das Garantie-Label erscheint nur, wenn dieser Wert größer als 24 ist (mehr als zwei Jahre). Der Händler ist nicht verpflichtet, diese Angabe selbst zu recherchieren.',
    'O3_GUARANTEE_ADMIN_HELP_GUARANTOR' => 'Name des Garantiegebers/der Marke für das Garantie-Label. Leer lassen, um automatisch den Hersteller-Titel zu verwenden.',
    'O3_GUARANTEE_ADMIN_HELP_MODEL' => 'Modellbezeichnung für das Garantie-Label (nach der EU-Durchführungsverordnung (EU) 2025/1960 ein Pflichtbestandteil des Labels). Leer lassen, um automatisch die Artikelnummer (OXARTNUM) zu verwenden.',
    'O3_GUARANTEE_ADMIN_HELP_CONDITIONS' => 'Garantiebedingungen bzw. Link zu den Garantiebedingungen (§ 479 BGB: Name/Anschrift des Garantiegebers, räumlicher Geltungsbereich, Bedingungen). Wird relevant, sobald das Garantie-Label angezeigt wird, da dies als Werbung mit der Garantie gilt.',
];
