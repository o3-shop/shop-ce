...
class Database implements DatabaseInterface
{
        ...
        if (!is_numeric($rowCount) || !is_numeric($offset)) {
            trigger_error(
                'Parameters rowCount and offset have to be numeric in DatabaseInterface::selectLimit(). ' .
                    'Please fix your code as this error may trigger an exception in future versions of O3-Shop.',
                E_USER_DEPRECATED
            );
        }
    ...
    /**
     * Log a given Exception the log file using the standard Shop logging mechanism.
