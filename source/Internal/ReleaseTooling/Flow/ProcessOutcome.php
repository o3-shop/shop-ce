...
/**
 * Captured exit-code + stdout + stderr from a single ProcessExecutor
 * invocation. Used by gates and per-repo actions for both decision-
 * making and diagnostic output.
 */
