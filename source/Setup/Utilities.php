...
class Utilities extends Core
{
     ...
     *
     * @param string $pathToConfigFile File path to Shop configuration file.
     *
    ...
    /**
     * Return full path to `demodata.sql` file of demodata package based on current Shop edition.
     *
     * @return string
     */
    ...
    /**
     * Return full path to demodata package based on current Shop edition.
     *
     * @return string
     */
