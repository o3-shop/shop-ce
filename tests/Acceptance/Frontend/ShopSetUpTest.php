...
{
    public const WELCOME_STEP = 'step0Submit';
    public const LICENSE_STEP = 'step1Submit';
    public const DATABASE_INFO_STEP = 'step2Submit';
    public const DIRECTORY_LOGIN_STEP = 'step3Submit';
    public const FINISH_CE_STEP = 'step4Submit';
    public const FINISH_PE_EE_STEP = 'step5Submit';

    public const CLICK_AND_WAIT_TIMEOUT = 2;

    public const SYNTAX_ERROR_STRING = 'SYNTAX ERROR!';

    public const DEMODATA_SQL_FILENAME = 'demodata.sql';
    public const DATABASE_SCHEMA_SQL_FILENAME = 'database_schema.sql';
    public const INITIAL_DATA_SQL_FILENAME = 'initial_data.sql';
    public const HTACCESS_FILENAME = '.htaccess';
    public const PACKAGE_INDICATOR_FILENAME = 'pkg.info';
    public const DB_MIGRATE_SCRIPT_FILENAME = 'oe-eshop-doctrine_migration';
    public const DB_VIEWS_REGENERATE_SCRIPT_FILENAME = 'oe-eshop-db_views_generate';

    public const SETUP_DIRECTORY = 'Setup';
    public const SOURCE_DIRECTORY = 'source';
    public const DEMODATA_SOURCE_DIRECTORY = 'src';
    public const SETUP_SQL_DIRECTORY = 'Sql';
    public const INVALID_MIGRATION_FILENAME = 'Version20170101.php';
    public const MIGRATION_DIRECTORY = 'migration';
    public const MIGRATION_DATA_DIRECTORY = 'data';
    public const VENDOR_DIRECTORY = 'vendor';
    public const VENDOR_BIN_DIRECTORY = 'bin';
    public const OXID_ESALES_VENDOR_DIRECTORY = 'oxid-esales';
    public const SHOP_DIRECTORY_FROM_COMPOSER_VENDOR_PATH = 'oxideshop-%s';
    public const DEMODATA_DIRECTORY_FROM_COMPOSER_VENDOR_PATH = 'oxideshop-demodata-%s';

    public const CE_EDITION_ID = 'CE';
    ...
    public function testInstallShop()
    {
        ...
        // Step 1
        $this->assertTextPresent('Welcome to O3-Shop installation wizard');
        ...
        $aMessages = [
            0 => 'Seems there is already O3-Shop installed in database',
            1 => 'Please provide necessary data for running O3-Shop',
        ];
        ...
        $this->type('aAdminData[sLoginName]', 'admin@my-o3-shop.com');
        ...
        $this->waitForText('Your O3-Shop has been installed successfully');
        ...
        $this->type('user', 'admin@my-o3-shop.com');
        ...
        $this->assertTextPresent('Welcome to the O3-Shop Admin.', 'Missing text: Welcome to the O3-Shop Admin.');
    }
    ...
    public function testSetupRedirectsToWelcomeScreenInCaseLicenseIsNotCheckedAsAgreed()
    {
        ...
        $this->waitForText('Welcome to installation wizard of O3-Shop');
    }
    ...
    public function testUserIsNotifiedIfAValidDatabaseAlreadyExistsBeforeTryingToOverwriteIt()
    {
        ...
        $this->waitForText("ERROR: Seems there is already O3-Shop installed in database $name. Please delete it prior continuing!");
        ...
        $this->waitForText('Please provide necessary data for running O3-Shop:');
    }
