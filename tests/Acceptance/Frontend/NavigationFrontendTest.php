...
class NavigationFrontendTest extends FrontendTestCase
{
    ...
    public function testFrontendFooter()
    {
        ...
        $this->assertTextPresent('What is O3-Shop?');
    ...
    public function testFrontendNewsBox()
    {
        ...
        $aShop = $this->callShopSC('oxShop', null, oxSHOPID, ['oxname']);
        ...
        $this->callShopSC('oxConfig', null, null, ['bl_perfLoadNewsOnlyStart' => ['type' => 'bool', 'value' => 'false']]);
        $this->clearCache();
        $this->openShop();
        $this->assertElementNotPresent('newsBox');
        $this->loginInFrontend('example_test@oxid-esales.dev', 'useruser');
        ...
        $this->callShopSC('oxConfig', null, null, ['bl_perfLoadNews' => ['type' => 'bool', 'value' => 'false']]);
        $this->clearCache();
        $this->openShop();
        $this->assertElementNotPresent('newsBox');
        $this->loginInFrontend('example_test@oxid-esales.dev', 'useruser');
    ...
    public function testFrontendTopMenu()
    {
        ...
        $this->callShopSC('oxConfig', null, null, ['iTopNaviCatCount' => ['type' => 'str', 'value' => '5', 'module' => 'theme:azure']]);
        $this->clearCache();
        $this->openShop();
    ...
    public function testFrontendCategorySorting()
    {
        ...
        $this->callShopSC('oxConfig', null, null, ['blShowSorting' => ['type' => 'bool', 'value' => 'false']]);
        $this->clearCache();
        $this->openShop();
        $this->clickAndWait('link=Test category 0 [EN] šÄßüл »');
        $this->assertEquals('Test category 0 [EN] šÄßüл', $this->getHeadingText('//h1'));
    ...
    public function testFrontendManufacturer()
    {
        ...
        $this->callShopSC('oxConfig', null, null, ['bl_perfLoadManufacturerTree' => ['type' => 'bool', 'value' => 'false']]);
        $this->clearCache();
        $this->openShop();
    ...
    public function testFrontendDistributors()
    {
        ...
        $this->callShopSC('oxConfig', null, null, ['bl_perfLoadVendorTree' => ['type' => 'bool', 'value' => 'false']]);
        $this->clearCache();
        $this->openShop();
    ...
    public function testFrontendPerfOptionsSelectionLists()
    {
        ...
        $this->callShopSC('oxConfig', null, null, ['bl_perfUseSelectlistPrice' => ['type' => 'bool', 'value' => 'false']]);
        ...
        $this->callShopSC('oxConfig', null, null, ['bl_perfLoadSelectListsInAList' => ['type' => 'bool', 'value' => 'false']]);
        ...
        $this->callShopSC('oxConfig', null, null, ['bl_perfLoadSelectLists' => ['type' => 'bool', 'value' => 'false']]);
    ...
    public function testFrontendContact()
    {
        ...
        $this->callShopSC('oxConfig', null, null, ['iUseGDVersion' => ['type' => 'str', 'value' => 2]]);
    ...
    public function testFrontendMessageWhenProductIsAddedToCart()
    {
        ...
        $this->callShopSC('oxConfig', null, null, ['iNewBasketItemMessage' => ['type' => 'select', 'value' => '1', 'module' => 'theme:azure']]);
        ...
        $this->callShopSC('oxConfig', null, null, ['iNewBasketItemMessage' => ['type' => 'select', 'value' => '2', 'module' => 'theme:azure']]);
    ...
    public function testFrontendPerfOptions1()
    {
        ...
        $this->callShopSC('oxConfig', null, null, ['bl_perfShowActionCatArticleCnt' => ['type' => 'bool', 'value' => true]]);
        // option -> performance-> "Calculate Shipping Costs"
        $this->callShopSC('oxConfig', null, null, ['bl_perfLoadDelivery' => ['type' => 'bool', 'value' => false]]);
        // option ->performance -> " Show Prices in "Top of the Shop" and "Just arrived!" "
        $this->callShopSC('oxConfig', null, null, ['bl_perfLoadPriceForAddList' => ['type' => 'bool', 'value' => false]]);
        ...
        $this->callShopSC('oxConfig', null, null, ['bl_perfLoadReviews' => ['type' => 'bool', 'value' => 'false']]);
        //option -> performance->"Calculate Product Price"
        $this->callShopSC('oxConfig', null, null, ['bl_perfLoadPrice' => ['type' => 'bool', 'value' => 'false']]);
        //option -> performance->"Load similar Products"
        $this->callShopSC('oxConfig', null, null, ['bl_perfLoadSimilar' => ['type' => 'bool', 'value' => 'false']]);
        //option -> performance->" 	Load Crossselling "
        $this->callShopSC('oxConfig', null, null, ['bl_perfLoadCrossselling' => ['type' => 'bool', 'value' => 'false']]);
        //option -> performance->"Load Accessories "
        $this->callShopSC('oxConfig', null, null, ['bl_perfLoadAccessoires' => ['type' => 'bool', 'value' => 'false']]);
        //theme option-> "Use compare list"
        $this->callShopSC('oxConfig', null, null, ['bl_showCompareList' => ['type' => 'bool', 'value' => 'false', 'module' => 'theme:azure']]);
        ...
        $this->callShopSC('oxConfig', null, null, ['bl_perfLoadAktion' => ['type' => 'bool', 'value' => 'false']]);
        //option -> performance->" Display Currencies"
        $this->callShopSC('oxConfig', null, null, ['bl_perfLoadCurrency' => ['type' => 'bool', 'value' => 'false']]);
        //option -> performance->" Display Languages"
        $this->callShopSC('oxConfig', null, null, ['bl_perfLoadLanguages' => ['type' => 'bool', 'value' => 'false']]);
    ...
    {
        if (isSUBSHOP) {
            $this->callShopSC('oxActions', 'save', 'oxbargain', ['oxshopid' => oxSHOPID], null, 1);
        }

        $aWeeksSpecialArticleParameters = [
            'oxshopid' => oxSHOPID,
        ...
        $this->callShopSC('oxActions', 'removeArticle', 'oxbargain', null, ['1000']);
        $this->clearCache();
        $this->openShop();
        $this->clickAndWait('link=%HOME%');
    ...
    public function testVariantsInLists()
    {
        ...
        $this->callShopSC('oxConfig', null, null, ['blLoadVariants' => ['type' => 'bool', 'value' => 'false']]);
    ...
    public function testCookieSettingsInFrontend()
    {
        ...
        // Enable cookienotes
        $this->callShopSC('oxConfig', null, null, ['blShowCookiesNotification' => ['type' => 'bool', 'value' => true]]);
