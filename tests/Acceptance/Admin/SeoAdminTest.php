...
class SeoAdminTest extends AdminTestCase
{
    ...
    public function testSeoCoreSettings()
    {
        ...
        $this->assertEquals("O3 Surf and Kite Shop", $this->getValue("editval[oxshops__oxtitleprefix]"));
        $this->selectAndWait("test_editlanguage", "label=Deutsch");
        $this->assertEquals("O3 Surf- und Kiteshop", $this->getValue("editval[oxshops__oxtitleprefix]"));
