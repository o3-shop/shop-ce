...
$aModule = [
    ...
    'title'       => 'Test O3-Shop class module chain extension 3.6',
    'description' => 'The module class and the chain extended O3-Shop class life in their namespaces. The O3-Shop class is from the unified namespace.',
