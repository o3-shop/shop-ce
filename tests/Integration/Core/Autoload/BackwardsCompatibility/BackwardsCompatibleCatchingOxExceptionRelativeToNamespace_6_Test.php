...
class BackwardsCompatibleCatchingOxExceptionRelativeToNamespace_6_Test extends \PHPUnit\Framework\TestCase
{
    ...
    public function testBackwardsCompatibleCatchingOxExceptionRelativeToNamespace()
    {
        ...
        try {
            ...
            $this->fail('The given exception (new \oxException()) was caught as oxException');
        } catch (\Exception $exception) {
            /** If the exception has not been caught before, the test has passed */
            $this->assertTrue(true, 'The given exception (new \oxException()) was not caught as oxException');
        }
    }
}
