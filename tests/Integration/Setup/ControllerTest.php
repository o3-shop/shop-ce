...
class ControllerTest extends \OxidEsales\TestingLibrary\UnitTestCase
{
    ...
    public function testDbConnectAllIsWellAndDatabaseAlreadyExists()
    {
        ...
        try {
            ...
            $this->assertStringContainsString('ERROR: Seems there is already O3-Shop installed in database', $view->getMessages()[0]);
    ...
    public function testDbConnectMySQLVersionDoesNotFitRecommendations()
    {
        ...
        try {
            ...
            $this->assertStringContainsString('WARNING: A bug in MySQL 5.6 may lead to problems in O3-Shop', $view->getMessages()[0]);
    ...
    public function testDbConnectMySQLVersionDoesNotFitRecommendationsDatabaseExists()
    {
        ...
        try {
            ...
            $this->assertStringContainsString('WARNING: A bug in MySQL 5.6 may lead to problems in O3-Shop', $view->getMessages()[0]);
            $this->assertStringContainsString('ERROR: Seems there is already O3-Shop installed in database', $view->getMessages()[1]);
