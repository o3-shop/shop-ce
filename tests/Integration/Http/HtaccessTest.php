...
class HtAccessTest extends \OxidEsales\TestingLibrary\UnitTestCase
{
    ...
    /**
     * Assure, that we get the wished HTTP code for the O3-Shop folders.
     *
    ...
    /**
     * Call an O3-Shop file URL over the shell cURL command. Assure, that the cURL command didn't failed.
     *
