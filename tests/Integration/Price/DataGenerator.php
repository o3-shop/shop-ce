    ...
    protected function _gatherExpectedData($aTestCase)
    {
        ...
        if ($aBasketItemList) {
            foreach ($aBasketItemList as $iKey => $oBasketItem) {
                ...
                $aExpected['articles'][$iArtId] = [$oBasketItem->getFUnitPrice(), $oBasketItem->getFTotalPrice()];
            }
        }
