...
class NewsletterControllerCaptchaTest extends UnitTestCase
{
    public function testAddmeRejectedWhenCaptchaFails(): void
    {
        ...
        $controller = $this->getMock(NewsletterController::class, ['getContainer']);
        $controller->method('getContainer')->willReturn($container);

        $this->assertFalse($controller->addme());
