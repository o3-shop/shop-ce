...
class InviteControllerCaptchaTest extends UnitTestCase
{
    public function testSendRejectedWhenCaptchaFails(): void
    {
        Registry::getSession()->deleteVariable('Errors');
        Registry::getConfig()->setConfigParam('blInvitationsEnabled', true);
        ...
        $controller = $this->getMock(InviteController::class, ['getContainer']);
