...
class ForgotPasswordControllerCaptchaTest extends UnitTestCase
{
    public function testForgotPasswordRejectedWhenCaptchaFails(): void
    {
        ...
        $controller = $this->getMock(ForgotPasswordController::class, ['getContainer']);
        $controller->method('getContainer')->willReturn($container);

        $this->assertFalse($controller->forgotPassword());
