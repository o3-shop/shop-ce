...
class SeoEncoderRecommTest extends \OxidTestCase
{
    ...
    public function testGetRecommUriCallCheckCantBeLoaded()
    {
        ...
        $oRecomm = $this->getMock(\OxidEsales\Eshop\Application\Model\RecommendationList::class, ['getId', 'getBaseStdLink']);
        ...
        $oEncoder = $this->getMock(\OxidEsales\Eshop\Application\Model\SeoEncoderRecomm::class, ['_loadFromDb', '_getStaticUri', '_prepareTitle', '_processSeoUrl', '_saveToDb']);
    ...
    public function testGetRecommUriCallCheck()
    {
        ...
        $oRecomm = $this->getMock(\OxidEsales\Eshop\Application\Model\RecommendationList::class, ['getId', 'getBaseStdLink', 'getStdLink']);
        $oRecomm->expects($this->any())->method('getId')->will($this->returnValue('testRecommId'));
    ...
    public function testGetRecommUri()
    {
        ...
        $oEncoder = $this->getMock(\OxidEsales\Eshop\Application\Model\SeoEncoderRecomm::class, ['_getStaticUri']);
    ...
    public function testGetRecommUrl()
    {
        ...
        $oEncoder = $this->getMock(\OxidEsales\Eshop\Application\Model\SeoEncoderRecomm::class, ['_getFullUrl', 'getRecommUri']);
