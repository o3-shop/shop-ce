...
class VarianthandlerTest extends \OxidTestCase
{
    ...
    public function testAssignValues()
    {
        ...
        $oVariantHandler = oxNew('oxVariantHandler');
        $aVar = $oVariantHandler->UNITassignValues($aValues, oxNew('oxArticleList'), $oArticle, ['en', 'de']);
    ...
    {
        $aParams = ['oxarticles__oxvarselect'      => '_testVar',
    ...
    public function testApplyVariantSelectionsFilter()
    {
        ...
        // no filter
        $aFilter = [];
        $this->assertEquals([$aArray, null, false], $oHandler->UNITapplyVariantSelectionsFilter($aArray, $aFilter));
        ...
        $aFilter = [md5('a1'), '', ''];
        $this->assertEquals([$aResult, 'test1', false], $oHandler->UNITapplyVariantSelectionsFilter($aArray, $aFilter));
        ...
        $this->assertEquals([$aResult, 'test2', false], $oHandler->UNITapplyVariantSelectionsFilter($aArray, $aFilter));
        ...
        $this->assertEquals([$aResult, 'test3', true], $oHandler->UNITapplyVariantSelectionsFilter($aArray, $aFilter));
    }
    ...
    {
        $oHandler = $this->getMock(\OxidEsales\Eshop\Application\Model\VariantHandler::class, ['_getSelections', '_fillVariantSelections', '_applyVariantSelectionsFilter', '_buildVariantSelectionsList']);
