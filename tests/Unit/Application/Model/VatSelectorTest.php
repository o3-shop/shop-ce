...
class VatSelectorTest extends \OxidTestCase
{
    ...
    {
        $oVatSelector = $this->getMock(\OxidEsales\Eshop\Application\Model\VatSelector::class, ['_getForeignCountryUserVat']);
    ...
    {
        $oVatSelector1 = $this->getMock(\OxidEsales\Eshop\Application\Model\VatSelector::class, ['_getVatForArticleCategory']);
    ...
    public function testGetVatCountryIsCalled()
    {
        ...
        $oVatSelector = $this->getMock(\OxidEsales\Eshop\Application\Model\VatSelector::class, ['_getVatCountry']);
