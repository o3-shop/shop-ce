...
class SeoDecoderTest extends \OxidTestCase
{
    ...
    public function testDecodeSimpleUrlForManufacturer()
    {
        ...
        $oDecoder->expects($this->exactly(2))
            ...
            ->withConsecutive(
                [$this->equalTo('manufacturer'), $this->equalTo('oxcategories'), $this->equalTo(0), $this->equalTo('oxcategory')],
                [$this->equalTo('manufacturer'), $this->equalTo('oxmanufacturers'), $this->equalTo(0), $this->equalTo('oxmanufacturer')]
            )
            ->willReturnOnConsecutiveCalls(null, 'manufacturerseourl');
    ...
    public function testDecodeSimpleUrlForVendor()
    {
        ...
        $oDecoder->expects($this->exactly(3))
            ->method('_getObjectUrl')
            ->withConsecutive(
                [$this->equalTo('vendor'), $this->equalTo('oxcategories'), $this->equalTo(0), $this->equalTo('oxcategory')],
                [$this->equalTo('vendor'), $this->equalTo('oxmanufacturers'), $this->equalTo(0), $this->equalTo('oxmanufacturer')],
                [$this->equalTo('vendor'), $this->equalTo('oxvendor'), $this->equalTo(0), $this->equalTo('oxvendor')]
            )
            ->willReturnOnConsecutiveCalls(null, null, 'vendorseourl');
