...
- [!] [Theme defaults: theme.php vs SQL drift](theme-defaults-consolidation.md) — Theme::activate only seeds settings declared in theme.php; before deleting theme SQL blocks verify theme.php is a complete superset (it wasn't — 8 missing in o3-theme); how to diff + the wipe→activate proof; setup.sql is dead/legacy (#122 phase 3)
